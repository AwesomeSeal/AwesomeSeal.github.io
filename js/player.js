...
let initialPlayer = {
  ...
  confirmations: {
    ...
    permanence: false,
    complexity: false,
    complexityReset: 'No confirmation',
    finality: false,
    singleStudyRefund: false,
    studiesRespec: false,
    eternityChallengeRespec: false,
    complexityChallengeEntering: false,
    powerDeletionMode: 'No confirmation',
    powerUnequipMode: 'No confirmation',
    powersUnequip: 'No confirmation',
    finalityShardUpgradesRespec: 'No confirmation',
    presetChange: true,
    presetDeletion: true,
  },
  stats: {
